...
int main() {
	...
	//打印地址
	cout << "局部变量a地址为： " << (int)&a << endl;  //局部变量保存在栈里
	cout << "局部变量b地址为： " << (int)&b << endl;

	cout << "全局变量g_a地址为： " <<  (int)&g_a << endl;  //全局变量存放在全局区
	...
	cout << "静态变量s_a地址为： " << (int)&s_a << endl;   //静态变量存放在全局区
	cout << "静态变量s_b地址为： " << (int)&s_b << endl;

	cout << "字符串常量地址为： " << (int)&"hello world" << endl;  //常量区中存放 const修饰的全局常量  和 字符串常量
