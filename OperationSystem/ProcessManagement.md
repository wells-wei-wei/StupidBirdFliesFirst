...
- [进程管理](#进程管理)
  ...
  - [进程调度](#进程调度)
    - [2.1 批处理系统](#21-批处理系统)
      - [2.1.1 先来先服务 first-come first-serverd（FCFS）](#211-先来先服务-first-come-first-serverdfcfs)
      - [2.1.2 短作业优先 shortest job first（SJF）](#212-短作业优先-shortest-job-firstsjf)
      - [2.1.3 最短剩余时间优先 shortest remaining time next（SRTN）](#213-最短剩余时间优先-shortest-remaining-time-nextsrtn)
    - [2.2 交互式系统](#22-交互式系统)
      - [2.2.1 时间片轮转](#221-时间片轮转)
      - [2.2.2 优先级调度](#222-优先级调度)
      - [2.2.3 多级反馈队列](#223-多级反馈队列)
    - [2.3 实时系统](#23-实时系统)
  - [进程同步](#进程同步)
    - [3.1 临界区](#31-临界区)
    - [3.2 同步与互斥](#32-同步与互斥)
